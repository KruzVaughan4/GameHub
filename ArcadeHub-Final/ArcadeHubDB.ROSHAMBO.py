...
def judgeGame(player, ai):
    ...
    game.round += 1
    if ai == "Rock":
        opponent = pygame.image.load("Images/s0.png")
    elif ai == "Scissors":
        opponent = pygame.image.load("Images/s1.png")
    elif ai == "Paper":
        opponent = pygame.image.load("Images/s2.png")
...
opponent = pygame.image.load("Images/q0.png")
rock = pygame.image.load("Images/d0.png")
scissors = pygame.image.load("Images/d1.png")
paper = pygame.image.load("Images/d2.png")
selectionBox = pygame.image.load("Images/box.png")
